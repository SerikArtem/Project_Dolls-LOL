...
function SendOrderO_1(){
            var data_1 = $(".SONameO_1").val();
            var data_2 = $(".SOPhoneO_1").val();
            var status = 0;
            
            $(".SONameO_1").css('background-color', '#ffffff');        
            $(".SOPhoneO_1").css('background-color', '#ffffff');
            ...
            if(status == 1){
                if(data_1 == ""){
                    $(".SONameO_1").css('background-color', '#ffcfcf');
                }
                if (data_2 == ""){
                    $(".SOPhoneO_1").css('background-color', '#ffcfcf');
                }
            }
            else{
                $.ajax({
                    type: "POST",
                    url: "php/Send_OrderO_1.php",
                    data: "&data_1="+data_1+"&data_2="+data_2	
                });
                
                $(".SONameO_1").val('');
                $(".SOPhoneO_1").val('');
                window.location="thankyou_1ball.html";
            }
		}

function SendOrderO_2(){
            var data_1 = $(".SONameO_2").val();
            var data_2 = $(".SOPhoneO_2").val();
            var status = 0;
            
            $(".SONameO_2").css('background-color', '#ffffff');        
            $(".SOPhoneO_2").css('background-color', '#ffffff');
            ...
            if(status == 1){
                if(data_1 == ""){
                    $(".SONameO_2").css('background-color', '#ffcfcf');
                }
                if (data_2 == ""){
                    $(".SOPhoneO_2").css('background-color', '#ffcfcf');
                }
            }
            else{
                $.ajax({
                    type: "POST",
                    url: "php/Send_OrderO_2.php",
                    data: "&data_1="+data_1+"&data_2="+data_2	
                });
